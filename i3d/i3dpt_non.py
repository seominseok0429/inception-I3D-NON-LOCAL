...
class I3D_NON(torch.nn.Module):
    def __init__(self,
        ...
        self.NonLocalBlock_mixed_3 = NonLocalBlock(480,480,240)    # Non-local
        ...
        self.NonLocalBlock_mixed_4 = NonLocalBlock(512,512,256)    # Non-local
    ...
    def forward(self, inp):
        ...
        out = self.NonLocalBlock_mixed_3(out)
        out = self.maxPool3d_4a_3x3(out)
        out = self.mixed_4b(out)
        out = self.mixed_4c(out)
        out = self.mixed_4d(out)
        out = self.NonLocalBlock_mixed_4(out)
